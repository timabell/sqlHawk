...
public class HtmlFormatter {
	...
	protected void writeHeader(Database db, Table table, String text, boolean showOrphans, List<String> javascript, LineWriter out) throws IOException {
		...
		out.writeln("</td>");;
		out.writeln("  <td class='heading' align='right' valign='top'><span class='indent'>Generated by</span><br><span class='indent'><span class='signature'><a href='http://github.com/timabell/sqlHawk' target='_blank'>sqlHawk</a></span></span></td>");
		out.writeln(" </tr>");
		out.writeln("</table>");
	}
