...
public class HtmlMultipleSchemasIndexPage extends HtmlFormatter {
	...
	private void writeHeader(String databaseName, DatabaseMetaData meta, int numberOfSchemas, boolean showIds, String aSchema, LineWriter html) throws IOException {
		...
		html.writeln("</h1></td>");
		html.writeln("  <td class='heading' align='right' valign='top' ><span class='indent'>Generated by</span><br><span class='indent'><span class='signature'><a href='http://timabell.github.com/sqlHawk/' target='_blank'>sqlHawk</a></span></span></td>");
		html.writeln(" </tr>");
		html.writeln("</table>");
